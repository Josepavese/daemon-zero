...
class AgentContext:
    ...
    def __init__(
        ...
        self.daemon0 = daemon0 or Agent(0, self.config, self)
        self.paused = paused
    ...
    def reset(self):
        self.kill_process()
        self.log.reset()
        self.daemon0 = Agent(0, self.config, self)
    ...
    def get_agent(self):
        return self.streaming_agent or self.daemon0
...
class Agent:
    ...
    def __init__(
        ...
        # agent context
        self.context = context or AgentContext(config=config, daemon0=self)
