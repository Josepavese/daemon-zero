...
def print_troubleshooting():
    ...
    print("   - Make sure DaemonZero is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ DaemonZero server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to DaemonZero server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start DaemonZero server if not running")
