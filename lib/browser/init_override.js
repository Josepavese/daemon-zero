...
//     if (out.name.startsWith("data-") && out.name != "data-DZUID" && out.name != "data-dz-frame-id") return null;
...
//           node.setAttribute("data-DZUID", uid);
//         }
...
//         if (tagName) {
//           content += ` selector="${node.getAttribute("data-DZUID")}"`;
//         }
...
//         content: content,
//         frameId: window.frameElement?.getAttribute('data-dz-frame-id')
//       }, '*');
//     }
//   });
...
//         iframe.setAttribute('data-dz-frame-id', frameId);
...
//       const frameId = iframe.getAttribute('data-dz-frame-id');
