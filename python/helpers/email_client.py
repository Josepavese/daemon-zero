...
class EmailClient:
    ...
    async def read_messages(
        ...
        Args:
            download_folder: Folder to save attachments (relative to /dz/)
    ...
    def _html_to_text(self, html_content: str, cid_map: Optional[Dict[str, str]] = None) -> str:
        ...
        Replaces inline images with [file:///dz/...] markers to maintain
        positional context.
        """
        cid_map = cid_map or {}
    ...
    async def _save_attachment_bytes(
        ...
        Uses DaemonZero's file helpers for path management.
        """
        # Sanitize filename
