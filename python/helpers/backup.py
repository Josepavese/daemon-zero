...
class BackupService:
    ...
    def get_default_backup_metadata(self) -> Dict[str, Any]:
        ...
        return {
            "backup_name": f"daemon-zero-backup-{timestamp[:10]}",
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes DaemonZero project directory patterns.
        """
...
"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up DaemonZero root path with the current DaemonZero root path
        ...
        for pattern in patterns:
            # Check if the pattern starts with the backed up DaemonZero root
    ...
    async def create_backup(
        ...
        backup_name: str = "daemon-zero-backup"
    ) -> str:
        ...
        try:
            ...
            with zipfile.ZipFile(temp_file, 'r') as zipf:
                ...
                for archive_path in archive_files:
                    # Archive path is already the correct relative path (e.g., "dz/tmp/settings.json")
                    ...
                    # so that patterns like "/home/rafael/dz/data/**" can match files correctly
    ...
    def _translate_restore_path(self, archive_path: str, backup_metadata: Dict[str, Any]) -> str:
        ...
        # Check if the archive path starts with the backed up DaemonZero root
